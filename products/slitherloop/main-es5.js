      ...
      _createClass(BoardComponent, [{
        ...
        value: function ngOnInit() {
          ...
          if (0 < this.sideWidth) {
            ...
            var rest = innerHeight - this.actionHeight - min;
        ...
        value: function ngAfterViewInit() {
          ...
          this.canvasDots.onclick = function (e) {
            ...
            _this.onClick(_this.clickAdjustX * (e.clientX - _this.sideWidth), // (this.clickAdjustY * (e.clientY - this.actionHeight))
            _this.clickAdjustY * e.clientY);
          };
